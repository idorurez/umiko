...
* **Conor at [KeebSupply](https://keebsupply.com)** — support and guidance on the [0xCB-Helios](https://github.com/0xCB-dev/0xCB-Helios) reference design that umiko's schematic patterns (RP2040 + dual flash + LDO + power path) build directly on.
